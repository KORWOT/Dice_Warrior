...
- 0시간: 탐험/전투 및 재굴림에서 0/0은 최대 두 표시 프레임 안에 Busy/모달을 종료하고 과거 .65 최소시간보다 빠르게 완료해야 한다. 굴림만0/hold=.3은 즉시 확정 면을 보여주면서 유지하며, 굴림=.3/hold만0은 굴림 후 추가 유지가 없어야 한다. .3초 단독 단계의 실제 완료 시점은 .28 이상/.55 미만이다.
